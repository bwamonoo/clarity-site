...
export default function ContactsTab() {
  ...
  // Use initial filter from tabState when component mounts
  useEffect(() => {
    if (tabState.contacts?.initialFilter) {
      setStatusFilter(tabState.contacts.initialFilter)
      // Clear the initial filter so it doesn't persist on next visit
      clearTabState('contacts')
    }
  }, [tabState.contacts?.initialFilter, clearTabState])

  // Rest of your existing ContactsTab code remains the same...
