...
import './styles/components/_toast.css'
import './styles/components/_breadcrumb.css'
import './styles/pages/_home.css'
import './styles/pages/_services.css'
import './styles/pages/_appointments.css'
import './styles/pages/_staff.css'
import './styles/pages/_admin.css'
import './styles/pages/_about.css'
import './styles/pages/_contact.css'
