...
// REMOVE useAdmin import since we don't need context here
// The login state is managed in the main Admin component

export default function AdminLogin({ onLogin }) {  // Keep onLogin prop
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      onLogin(data.user)  // Call the prop function
    } catch (err) {
